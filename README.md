...
The extension integrates with the [**Datadog MCP Server**](#mcp-server-setup) which is configured separately.
...
The extension works well alongside the [Datadog MCP Server][mcp_server]. Enable the MCP Server to enhance your IDE's AI capabilities with your specific Datadog environment.
...
Follow the [Datadog MCP Server setup guide][mcp_setup_vscode] to configure the Datadog MCP Server in VS Code.
...
[mcp_setup_vscode]: https://docs.datadoghq.com/mcp_server/setup/?tab=vscode
